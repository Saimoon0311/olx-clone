...
export default function Servicealldata({ navigation }) {
  const back = () => {
    navigation.goBack()
  }
  ...
  useEffect(() => {
    fetch('https://olx.devoa.xyz/api/services_cat')
      ...
      {isLoading ? <ActivityIndicator size={100} color="#0c0e87" style={{ marginTop: 200 }} /> :
        <View style={{ backgroundColor: "#0c0e87", position: "relative" }} >
          <View style={styles.head}>
            ...
            <Text style={{ color: "white", textAlign: "center", fontSize: 20 }} >Services Ads</Text>
          </View>
