...
export default function Propertyforrent ({navigation},props){
          // const ty = 
          const [subcat_id, setSubcat_id] = useState(null);
          const [cat_id,setCat_id] = useState(4)
          ...
          const[is_furnished,setIs_furnished]=useState()
...
<View  style={[styles.pick,{borderColor:"black",borderWidth:5}]}>
  ...
  onValueChange={(itemValue, itemIndex) =>{
   ...
   >
      ...
      <Picker.Item label="Houses" value={28} />
      <Picker.Item label="Apartments & Flats" value={29} />
      <Picker.Item label="Portions & Floors" value={30} />
      <Picker.Item label="Shops - Offices - Commercials Spaces" value={31} />
      <Picker.Item label="Roommates & Paying Guests" value={32} />
      <Picker.Item label="Rooms" value={33} />
      <Picker.Item label="Vacation Rentals - Guests Houses" value={34} />
      <Picker.Item label="Land & Plots" value={35} />
   </Picker>
</View>
...
{subcat_id===29 || subcat_id===30 || subcat_id===32 || subcat_id=== 33 || subcat_id===34 ?
<View>
