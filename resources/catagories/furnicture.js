...
export default function Furnicture ({navigation},prop){
          // const ty = 
          const [subcat_id, setSubcat_id] = useState(null);
          const [cat_id,setCat_id] = useState(11)
...
>
            <Picker.Item label="Furniture & Home Decor" value={null}/>

            <Picker.Item label="Sofa & Chairs" value={99} />
  <Picker.Item label="Beds & Wardrobes"  value={100} />
  <Picker.Item label="Home Decorations" value={101} />
  <Picker.Item label="Tables & Dinings" value={102} />
  <Picker.Item label="Garden & Outdoor" value={103} />
  <Picker.Item label="Painting & Mirrors" value={104} />
  <Picker.Item label="Rugs & Carpets" value={105} />
  <Picker.Item label="Curtains & Blinds" value={106} />
  <Picker.Item label="Office Furniture" value={107} />
  <Picker.Item label="Other Households Items" value={108} /> 
</Picker>
</View>
