...
export default function Electronic ({navigation},prop){
          // const ty = 
          const [subcat_id, setSubcat_id] = useState(null);
          const [cat_id,setCat_id] = useState(5)
...
>
            <Picker.Item label="Electronics And Home Appliances" value={null}/>

            <Picker.Item label="Computer & Accessories" value={36} />
  <Picker.Item label="Tv - Video - Audio"  value={37} />
  <Picker.Item label="Cameras & Accessories" value={38} />
  <Picker.Item label="Games & Entertainmint" value={39} />
  <Picker.Item label="Other Home Appliances" value={42} />
  <Picker.Item label="Generator UPS & Power Solution" value={43} />
  <Picker.Item label="Kitchen Appliances" value={44} />
  <Picker.Item label="Ac & Cooler" value={45} />
  <Picker.Item label="Fridge & Freezer" value={46} />
  <Picker.Item label="Washing Machine & Dryers" value={47} /> 
</Picker>
</View>
