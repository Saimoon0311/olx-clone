...
export default function Property ({navigation},props){
          // const ty = 
          const [subcat_id, setSubcat_id] = useState(null);
          const [cat_id,setCat_id] = useState(10)
...
>
            <Picker.Item label="Choose Your Pet Type" value={null}/>

            <Picker.Item label="Fish & Aquariums" value={90} />
  <Picker.Item label="Birds"  value={91} />
  <Picker.Item label="Hens & Aseel" value={92} />
  <Picker.Item label="Cats" value={93} />
  <Picker.Item label="Dogs" value={94} />
  <Picker.Item label="Livestock" value={95} />
  <Picker.Item label="Horses" value={96} />
  <Picker.Item label="Pet Food & Accessories" value={97} />
   <Picker.Item label="Other Animals" value={98} />
</Picker>
</View>
