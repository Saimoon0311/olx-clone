...
export default function Business ({navigation},props){
          console.log(props.name)
          const [subcat_id, setSubcat_id] = useState(null);
          const [cat_id,setCat_id] = useState(7)
...
>
            <Picker.Item label="Choose Your Business Type" value={null}/>
            <Picker.Item label="Business For Sale"  value={53} />
  <Picker.Item label="Food & Restaurants" value={54} />
  <Picker.Item label="Trade & Industrial" value={55} />
  <Picker.Item label="Construction & Heavy Machinery" value={56} />
  <Picker.Item label="Agriculture" value={57} />
  <Picker.Item label="Other Business & Industry" value={58} />
  <Picker.Item label="Medical & Pharma" value={59} />
</Picker>
