...
export default function Propertyforselldata({navigation}){
  const [isLoading, setLoading] = useState(true);
  const [data, setData] = useState();
  console.log("data======>>>>>>>",data);

  useEffect(() => {
    fetch('https://olx.devoa.xyz/api/pfc_cat')
                   ...
                   {isLoading ?<ActivityIndicator size="large" color="#06065e" style={{marginLeft:60}} />: 
                        ...
                        renderItem={({item})=>{
                                  return(
                                            ...
                                            // // }}
                                            // >
                                            <View style={{justifyContent:"space-around",paddingLeft:20,paddingTop:10,paddingRight:10}}>
